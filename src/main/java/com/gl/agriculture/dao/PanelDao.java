...
public class PanelDao {
	...
	{
		return jdbcTemplate.query("select * from contents where publisher='GLM'", new  ResultSetExtractor<List<PanelContentModal>>() {
	...
	public PanelContentModal  panelvideo(int id)
	{
		...
		return jdbcTemplate.query("select * from contents where content_id='"+id+"' and publisher='GLM'", new  ResultSetExtractor<PanelContentModal>() {
