...
<body style="background:black;">
    ...
    <div class="full-screen-portfolio" id="portfolio">
        ...
        <video style="width:100%;height:584px;margin-left:0%;" src="${context}/resources/img/MobileMagzine/${imagename}.mp4" controls="" type="video/mp4"></video>
        </div>
        <div style="padding: 10px;">
        <a href="${context}/resources/img/MobileMagzine/${imagename}.mp4" download="">
    ...
    <footer>
        <div class="container-fluid">
            <div class="col-md-12">
                <p>Copyright &copy; 2020 MobileMagzine 
            </div>
        </div>
    </footer>
