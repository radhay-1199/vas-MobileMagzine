...
<body>
	...
	<div id="video-container">
		...
		<div class="video-content">
			<div class="inner">
				<h1>
					Welcome to <em>MobileMagzine</em>
				</h1>
				<p>Homepage with full-width MobileMagzine Videos</p>
				<p>Watch and Download MobileMagzine Videos</p>
					...
					<div class="portfolio-item">
						<a href="./videopanelplayer/cnt_Id=${item.cnt_id}"
							class="img-responsive"><div class="thumb">
								...
								<div class="image">
									<img src="${context}/resources/img/thumbnails/MobileMagzine/${item.image_name}.jpg">
								</div>
							</div></a>
					</div>
				</div>
